...
::: {align="justify" style="text-indent: 3em;"}
Analisando a soma dos lucros dos filmes por gênero, tem-se aventura, ação e comédia os mais lucrativos. Na tabela 08, encontra-se a lista dos 10 maiores lucros por gênero.
:::
...
::: {align="justify" style="text-indent: 3em;"}
Considerando que certos gêneros produzem mais filmes que outros, pode-se encontrar os gêneros mais lucrativos por filme.
:::
<br>
...
A tabela 09 traz o ranking de lucros por gêneros e quantidades de filmes. Animação e aventura são os com maiores faturamentos médios por filme.
...
Na construção do gráfico 05, consideramos todas as categorias, independentemente da quantidade de filmes produzidos em cada classe. O resultado apresentou *film Noir* como o gênero com a melhor média. 

Até hoje, não existe consenso sobre *film Noir* ser uma categoria de filmes ou um estilo de filmagem. Esta categoria refere-se a filmes de longa metragem típicas dos anos 40, combinando temas policiais, criminais e marcados pela presença de anti-heróis e ambientes urbanos.

Atualmente, acredita-se que neste gênero existam cerca de 300 títulos produzidos entre 1940 e 1958. 
...
Agora, aprentaremos as informações sobre o filme Avatar obtidas a partir da base Imdb.
...
Além dos 7 filmes listados na base e relacionados na tabela 10, também atuou como diretor/roteirista nos filmes Piranha II: The spawning, Terminator, Rambo: First Blood Part II, The Abyss, Strange Days, Ghosts of the Abyss e Alita: Battle Angel.
:::
...
#### 10.4 - Lucro médios dos filmes James Cameron na base
...
::: {align="justify" style="text-indent: 3em;"}
O lucro médio dos `r nrow(filmes_cameron)` filmes listados na base Imdb foi de `r lucro_medio_filmes`. Avatar com um ganho de `r filmes_cameron$lucro[7]` e Titanic com um ganho de `r filmes_cameron$lucro[6]` foram aqueles com maiores lucros.
...
Entre os filmes de James Cameron,  a nota de Avatar não é a mais alta entre os listados, com 7,8 é inferior às notas de Exterminador, Aliens e Exterminador 2. Entretanto, Avatar e Titanic foram os filmes com as maiores receitas, como podemos ver no gráfico 06.
...
#### 10.6 - Posição de Avatar no ranking do maiores lucros
...
::: {align="justify" style="text-indent: 3em;"}
A estreia nas salas de cinemas dos Estados Unidos ocorreu em `r imdb_novo_ordenado |> filter(titulo == "Avatar") |> select(data_lancamento)`, em uma sexta-feira. Neste dia, tinha `r as.duration(year("2010-01-15") - year("1982-06-07"))` anos de idade. 
...
::: {align="justify" style="text-indent: 3em;"}
Procuramos neste trabalho explorar os recursos do **tidyverse** e suas funções na arrumação e na transformação dos dados, adicionando colunas, filtrando linhas e selecionando colunas, agrupando e resumindo dados, desta forma conseguimos extrair da base Imdb interessantes informações sobre filmes e artistas. 

Curiosidades como a grande quantidade de filmes americanos na base, os grandes valores de receitas, gastos e lucros que a indústria cinematográfica movimenta e particularidades sobre os gêneros dos filmes. 

Na seção 10, trouxemos algumas informações sobre o meu filme preferido, Avatar, e descobrimos interessantes curiosidades sobre esta obra e seu diretor James Cameron. 
 
A base permite a descoberta de muitas outras informações além daquelas que apresentamos neste trabalho e se constitui em uma das 
