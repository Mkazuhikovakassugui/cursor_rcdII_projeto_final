...
Foram `r top_22_paises[[2]][1]` filmes produzidos nos EUA.  

Já o Brasil possui `r top_22_paises[[2]][22]` filmes na base, são obras de 1931 a 2020. A melhor média é a do filme "O Auto da Compadecida", avaliada por `r paste(top_5_filmes_brasil[[5]][1])`  pessoas, que possui média de `r top_5_filmes_brasil[[4]][1]`.  
...
A partir da base, relacionamos algumas informações sobre o filme Avatar.
...
::: {align="justify" style="text-indent: 3em;"}
"**`r imdb_avatar$titulo`**" pertence aos gêneros `r imdb_avatar$genero`. Sua *premiere* ocorreu em `r imdb_avatar$data_lancamento`,  com duração de `r imdb_avatar$duracao` minutos sob a direção de `r imdb_avatar$direcao`. Roteiro de `r imdb_avatar$roteiro`.  
...
Ao longo de sua carreira, também conquistou os Oscars de melhor filme, melhor direção e melhor edição em 1998 com "Titanic".
:::
