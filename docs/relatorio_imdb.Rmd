...
# <font color = #142452> Introdução </font>
...
# <font color = #142452> Análises </font>
...
### <font color = #142452> 1.Mês histórico </font>
...
p_filmes_ano <- imdb |> 
  ...
  gghighlight(ano_lancamento >=1960,                    # destaca os dados com ano_lançamento superior a 1960.
              unhighlighted_params = list(colour = "#99D8FF"
                                          )
              )+
...
imdb <- imdb |>                                              
  mutate(data_lancamento = ymd(data_lancamento))                                # converte variável para date.                       

imdb_datas <- imdb |>
  mutate(mes = floor_date(data_lancamento, "month"))                    # cria coluna mes - dia 1 de cada mês.
...
top_20_paises |> 
  ...
  theme(
    ...
    plot.title = element_text(                                          # título do gráfico.
      size = 24,
      face = "bold",
      family = "Arial",
      hjust = 0.5,
