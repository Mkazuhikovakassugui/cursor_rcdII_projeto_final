...
::: {align="justify" style="text-indent: 3em;"}
Abaixo, apresentamos um resumo escrito a partir dos dados da base *imdb* e uma breve sinopse destes filmes .
:::
...
```{r tab03 - dia com o maior numero de lancamentos}

# Tabela 03 - Dia com o maior número de lancamentos
...
### Tabela com o maior número de lançamentos

tab03 <- dia_maior_lancamento |>                                                                
  kbl(align = "l",                                                      
      col.names = c("Dia",                                                
                  "Quantidade de Filmes"
                  ),
...
```{r tab04 - top 5 de paises com mais filmes na base}
#| fig.out = 100
...
```{r tab05 - melhores filmes brasileiros - ranking imdb }
...
```{r tab06 - relacão de moedas da base}
...
```{r tab08 - lucro por genero e quantidade de filme}
...
#### 7.4- Nota média do filme Avatar
...
# cria a tabela 11 com dados de Avatar e sua posição no ranking
...
```{r tab14 - filmes lançados no mesmo dia}
